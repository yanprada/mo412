...
DATABASES: dict[str, DataSource] = {
    "links_high_tension": DataSource(
        ...
        path="data/silver/links_high_tension.parquet",
        layer="SSDAT",
        crs="EPSG:4326",
    ),
    "links_medium_tension": DataSource(
        name="links_medium_tension",
        path="data/silver/links_medium_tension.parquet",
        layer="SSDMT",
        crs="EPSG:4326",
    ),
    "links_low_tension": DataSource(
        name="links_low_tension",
        path="data/silver/links_low_tension.parquet",
        layer="SSDBT",
        crs="EPSG:4326",
    ),
    "points": DataSource(
        name="points",
        path="data/silver/points.parquet",
        layer="PONNOT",
        crs="EPSG:4326",
    ),
    "consumers_high_tension": DataSource(
        name="consumers_high_tension",
        path="data/silver/consumers_high_tension.parquet",
        layer="UCAT_tab",
        crs="EPSG:4326",
    ),
    "consumers_medium_tension": DataSource(
        name="consumers_medium_tension",
        path="data/silver/consumers_medium_tension.parquet",
        layer="UCMT_tab",
        crs="EPSG:4326",
    ),
    "consumers_low_tension": DataSource(
        name="consumers_low_tension",
        path="data/silver/consumers_low_tension.parquet",
        layer="UCBT_tab",
        crs="EPSG:4326",
    ),
    "suppliers_high_tension": DataSource(
        name="suppliers_high_tension",
        path="data/silver/suppliers_high_tension.parquet",
        layer="UGAT_tab",
        crs="EPSG:4326",
    ),
    "suppliers_medium_tension": DataSource(
        name="suppliers_medium_tension",
        path="data/silver/suppliers_medium_tension.parquet",
        layer="UGMT_tab",
        crs="EPSG:4326",
    ),
    "suppliers_low_tension": DataSource(
        name="suppliers_low_tension",
        path="data/silver/suppliers_low_tension.parquet",
        layer="UGBT_tab",
        crs="EPSG:4326",
    ),
    "substations": DataSource(
        name="substations",
        path="data/silver/substations.parquet",
        layer="SUB",
        crs="EPSG:4326",
    ),
    "raw_data": DataSource(
        name="raw_data",
        path="data/bronze/CPFL_PAULISTA - 2023-12-31.gdb.zip",
        layer=None,
        crs="EPSG:4674",
    ),
}
